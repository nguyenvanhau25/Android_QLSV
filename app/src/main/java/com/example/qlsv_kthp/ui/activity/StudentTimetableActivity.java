...
public class StudentTimetableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnExportPdf.setOnClickListener(v -> Toast.makeText(this, "Tải PDF thành công", Toast.LENGTH_SHORT).show());
        binding.btnExportIcs.setOnClickListener(v -> Toast.makeText(this, "Đã xuất ra lịch máy", Toast.LENGTH_SHORT).show());
        ...
        binding.rvDayHeaders.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
